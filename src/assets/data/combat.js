export default {
  "The Order of Combat": {
    ...
    "Combat Step by Step": [
      ...
      "**Establish positions.** The GM decides where all the characters and monsters are located. Given the adventurers’ marching order or their stated positions in the room or other location, the GM figures out where the adversaries are in relation to the players.",
    ...
    "Your Turn": {
      "content": [
        ...
        "The most common actions you can take are described in the “Actions in Combat”. Many class features and other abilities provide additional options for your action.",
        "The “Movement and Position” gives the rules for your move.",
    ...
    "Reactions": {
      "content": [
        "Certain special abilities, spells, and situations allow you to take a special action called a reaction. A reaction is an instant response to a trigger of some kind, which can occur on your turn or on someone else’s. The opportunity attack, described later in this article, is the most common type of reaction.",
  ...
  "Movement and Position": {
    ...
    "Being Prone": {
      "content": [
        "Combatants often find themselves lying on the ground, either because they are knocked down or because they throw themselves down. In the game, they are prone, a condition described in Conditions.",
    ...
    "Moving Around Other Creatures": {
      "content": [
        ...
        "If you leave a hostile creature’s reach during your move, you provoke an opportunity attack, as explained later in the article."
      ]
    },
  ...
  "Actions in Combat": {
    ...
    "Hide": "When you take the Hide action, you make a Dexterity (Stealth) check in an attempt to hide, following the rules for hiding. If you succeed, you gain certain benefits, as described in the “Unseen Attackers and Targets”.",
    "Ready": {
      "content": [
    ...
    "Attack Rolls": {
      ...
      "Rolling 1 or 20": {
        "content": [
          ...
          "If the d20 roll for an attack is a 20, the attack hits regardless of any modifiers or the target’s AC. This is called a critical hit, which is explained later in this article.",
  ...
  "Damage and Healing": {
    ...
    "Dropping to 0 Hit Points": {
      ...
      "Falling Unconscious": "If damage reduces you to 0 hit points and fails to kill you, you fall unconscious (see Conditions). This unconsciousness ends if you regain any hit points.",
      "Death Saving Throws": {
        "content": [
